import { toConversionResult, toWorkflowConversionResult } from '../../lib/utils/interface-adapters';
import { 
  ConversionLog, 
  ParameterReview,
  WorkflowDebugInfo
...
describe('Interface Adapters', () => {
  describe('toConversionResult', () => {
    it('should convert WorkflowConversionResult to ConversionResult', () => {
      const workflowResult = {
        ...
        logs: [
          { type: 'info' as const, message: 'Converting node: HTTP Request', timestamp: '2023-01-01T00:00:00.000Z' },
          { type: 'info' as const, message: 'Conversion successful', timestamp: '2023-01-01T00:00:01.000Z' }
        ],
        paramsNeedingReview: [
      ...
      const result = toConversionResult(workflowResult);
  ...
  describe('toWorkflowConversionResult', () => {
    it('should convert ConversionResult to WorkflowConversionResult', () => {
      ...
      const result = toWorkflowConversionResult(conversionResult);
