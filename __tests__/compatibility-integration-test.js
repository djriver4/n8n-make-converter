...
const makeResult = (0, workflow_converter_1.convertN8nToMake)(testN8nWorkflow);
console.log("N8n to Make conversion successful:", !!makeResult);
console.log("Result type matches expected ConversionResult:", makeResult &&
...
const makeWorkflow = makeResult.convertedWorkflow;
const n8nResult = (0, workflow_converter_1.convertMakeToN8n)(makeWorkflow);
console.log("Make to N8n conversion successful:", !!n8nResult);
console.log("Result type matches expected ConversionResult:", n8nResult &&
