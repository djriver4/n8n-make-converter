...
exports.baseMappings = exports.FunctionNodeMapping = exports.WebhookNodeMapping = exports.EmailNodeMapping = exports.HttpNodeMapping = exports.baseNodeMapping = void 0;
exports.getBaseMappingBySourceType = getBaseMappingBySourceType;
exports.getBaseMappingByTargetType = getBaseMappingByTargetType;
/**
 * Base node mapping database
 * Contains mappings for common n8n nodes to Make.com modules
 */
exports.baseNodeMapping = {
    // Email nodes
 ...
 */
function getBaseMappingBySourceType(sourceType) {
    return exports.baseMappings.find(mapping => mapping.sourceType === sourceType);
}
/**
 ...
 * @returns The matching base mapping or undefined if not found
 */
function getBaseMappingByTargetType(targetType) {
    return exports.baseMappings.find(mapping => mapping.targetType === targetType);
}
