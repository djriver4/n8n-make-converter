 ...
 */
export function optimizeWorkflow(workflowJson: any): any {
 ...
 */
export function isWorkflowLarge(workflowJson: any): boolean {
 ...
 */
export function getPerformanceWarning(workflowJson: any): string | null {
