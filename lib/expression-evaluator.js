...
exports.advancedExpressionFunctions = void 0;
exports.extractExpressionContent = extractExpressionContent;
exports.isExpression = isExpression;
exports.processValueWithPossibleExpression = processValueWithPossibleExpression;
exports.processObjectWithExpressions = processObjectWithExpressions;
exports.evaluateComplexExpression = evaluateComplexExpression;
exports.convertN8nExpressionToMake = convertN8nExpressionToMake;
exports.convertMakeExpressionToN8n = convertMakeExpressionToN8n;
 ...
 */
exports.advancedExpressionFunctions = {
 ...
 */
function extractExpressionContent(expressionString) {
 ...
 */
function processValueWithPossibleExpression(value, context) {
 ...
 */
function processObjectWithExpressions(obj, context) {
 ...
 */
function evaluateEmbeddedExpressions(str, context) {
 ...
 */
function evaluateComplexExpression(expression, context) {
 ...
 */
function convertN8nExpressionToMake(expression) {
 ...
 */
function convertMakeExpressionToN8n(expression) {
    if (!isExpression(expression) || !expression.startsWith('{{')) {
        return expression;
    }
    // Extract expression content
 ...
 */
function convertExpressions(obj, direction) {
            ...
            try {
                ...
                for (const match of variableMatches) {
                    ...
                    if (context[contextPrefix]) {
                        ...
                        processedExpression = processedExpression.replace(fullMatch, JSON.stringify(value) // Use JSON.stringify to properly handle quotes
                        );
                    }
                }
