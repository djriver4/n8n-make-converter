...
exports.toWorkflowConversionResult = exports.toConversionResult = void 0;
exports.createTimestamp = createTimestamp;
exports.ensureValidLogEntry = ensureValidLogEntry;
exports.createDefaultDebugInfo = createDefaultDebugInfo;
exports.ensureArray = ensureArray;
exports.isValidWorkflowConversionResult = isValidWorkflowConversionResult;
exports.isValidConversionResult = isValidConversionResult;
exports.createErrorWorkflowResult = createErrorWorkflowResult;
exports.createErrorConversionResult = createErrorConversionResult;
exports.paramReviewToString = paramReviewToString;
exports.stringToParamReview = stringToParamReview;
exports.convertToLegacyResult = convertToLegacyResult;
exports.convertToModernResult = convertToModernResult;
 ...
 * ```
 */
function ensureValidLogEntry(entry) {
 ...
 */
function createDefaultDebugInfo() {
    return {
        mappedModules: [],
        unmappedModules: [],
        mappedNodes: [],
 ...
 */
function isValidWorkflowConversionResult(result) {
    return result !== null &&
 ...
 * @returns True if valid, false otherwise
 */
function isValidConversionResult(result) {
    return result !== null &&
        typeof result === 'object' &&
        typeof result.convertedWorkflow === 'object';
}
 ...
 */
function createErrorWorkflowResult(errorMessage) {
    return {
 ...
 */
function createErrorConversionResult(errorMessage) {
    return {
        convertedWorkflow: { name: 'Error', nodes: [] },
        logs: [{
                type: 'error',
 ...
 * ```
 */
function paramReviewToString(review) {
    try {
 ...
 * ```
 */
function stringToParamReview(str) {
    try {
 ...
 * ```
 */
function convertToLegacyResult(result) {
    ...
    try {
        ...
        const unmappedNodes = ensureArray(result.unmappedNodes);
        ...
        return createErrorConversionResult(`Error converting to legacy result: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
}
/**
 ...
 * ```
 */
function convertToModernResult(result) {
    // Handle invalid input
    ...
    try {
        ...
        // If any error occurs during conversion, return an error result
        return createErrorWorkflowResult(`Error converting to modern result: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
}
 ...
 */
exports.toConversionResult = convertToLegacyResult;
/**
 * Alias for convertToModernResult - maintained for backwards compatibility
 */
exports.toWorkflowConversionResult = convertToModernResult;
