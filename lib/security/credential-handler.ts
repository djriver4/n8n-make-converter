 ...
 */
export function sanitizeCredentials(workflowJson: any): any {
  ...
  if (sanitized.flow && Array.isArray(sanitized.flow)) {
    sanitized.flow = sanitized.flow.map((module: any) => {
      if (module.parameters) {
        const sanitizedParams = { ...module.parameters }
 ...
 */
export function hasCredentials(workflowJson: any): boolean {
